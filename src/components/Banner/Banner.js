  ...
  return (
    <div className="banner_conatainer" >
      <div className="container-fluid" >
        <div className="row bg_container" style={{backgroundImage:`url(${banner})`,backgroundSize:'cover',backgroundRepeat:'no-repeat'}} >
          <div className="col-1"></div>
          <div className="col-md-5 col-lg-5 left_main_content">
